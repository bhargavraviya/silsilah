...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(User::class, 'couples', 'husband_id', 'wife_id')->using(CouplePivot::class)->withPivot(['id'])->withTimestamps()->orderBy('marriage_date');
    }
    ...
    {
        return $this->belongsToMany(User::class, 'couples', 'wife_id', 'husband_id')->using(CouplePivot::class)->withPivot(['id'])->withTimestamps()->orderBy('marriage_date');
    }
